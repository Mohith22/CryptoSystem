...
#Input for this is - Cipher text obtained from encryption program

import sys

text = raw_input("Enter The Cipher Text : ")
...
for i in bits:
	...
	for q in range(16):
		...
		px = ''
		for x in range(48):
			px+=str((int(keys[15-q][x]))^(int(pb[x]))) # px is 48 bit Output after Xoring
